...
public class MainPageTest {
    ...
    @BeforeEach
    public void setUp() {
        open("https://www.legrandrestaurant.fr/");
    }



    @Test
    public void NosRestaurantMenuIsVisibleAndExpanded() {
        mainPage.seeRestaurant.click();

        $("a.elementor-item.elementor-item-anchor.has-submenu").shouldBe(visible);
        $("a.elementor-item.elementor-item-anchor.has-submenu").shouldHave(attribute("aria-expanded", "true"));
    ...
    public void Serveur_initial(){
        ...
        Assertions.assertEquals(0,chiffreAffaire,0);
    }
    ...
    public void Serveur_increment(){
        ...
        Assertions.assertEquals(montantCommande,s.getChiffreAffaires(),0);
    }
    ...
    public void Serveur_2_commandes(){
        ...
        Assertions.assertEquals(montantPremiereCommande + montantSecondeCommande,s.getChiffreAffaires(),0);
    ...
    public void Restaurant(){
        ...
        Assertions.assertEquals(montantCommande + montantCommande, r.chiffreAffaires(),0);
    }
    ...
    public void Franchise(){
        ...
        Assertions.assertEquals(montantCommande *3 + montantCommande2 * 3, f.chiffreAffaires(),0);
    ...
    public void AvantService_Initial(){
        ...
        Assertions.assertEquals(r.getListTable().size(),0);
    }
    ...
    public void Ajout_table(){
        ...
        Assertions.assertEquals(r.getListTable().size(),2);
    }
    ...
    public void Ajout_table_plus_grand_que_restaurant(){
        ...
        Assertions.assertEquals(r.getListTable().size(),3);
    }
    ...
    public void Service_Initial(){
        ...
        for(Table t: r.getListTable()){
            Assertions.assertEquals(t.getAffectation(),r.getMaitreHotel());
        }
    }
